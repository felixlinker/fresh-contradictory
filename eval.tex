...
Figure~\ref{fig:benchmarks} shows the result of the benchmarks as box-and-whisker diagram.
...
We conjecture that checking for fresh-contradictory rule variants takes extra time but does not benefit the more complex precomputations following later.
As for proof times, we observed that Tamarin's heuristics prioritize solving equations with many and with few equations differently.
